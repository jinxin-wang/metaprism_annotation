...
def main(args):
    ...
    if df_inp_maf_snp.shape[0] != df_inp_maf_snp[col_row_id_snp].nunique(): 
        print("[Error] %d SNPs in maf table" % df_inp_maf_snp.shape[0])
        print("[Error] %d SNPs in maf table" % df_inp_maf_snp[col_row_id_snp].nunique())
